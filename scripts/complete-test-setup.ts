...
async function main() {
  ...
  const profiles = [
    {
      ...
      project_preferences: { preferred_stack: ['React', 'TypeScript'], commitment_level: '15', timeline_preference: '3_months' }
    },
    {
      id: testUsers.bob,
      ...
      project_preferences: { preferred_stack: ['Python', 'AI'], commitment_level: '40', timeline_preference: '6_months' }
    },
    {
      id: testUsers.carol,
      ...
      project_preferences: { preferred_stack: ['React', 'CSS'], commitment_level: '40', timeline_preference: '1_month' }
    },
    {
      id: testUsers.david,
      ...
      portfolio_url: null,
      project_preferences: { preferred_stack: ['Node.js', 'PostgreSQL'], commitment_level: '20', timeline_preference: '3_months' }
    },
    {
      id: testUsers.emma,
      ...
      project_preferences: { preferred_stack: ['Vue.js', 'Python'], commitment_level: '10', timeline_preference: '1_month' }
    }
  ];
  ...
  const projects = [
    {
      ...
      description: 'Building an intelligent task management app that uses ML to predict completion times. Need frontend developer.',
    ...
    },
    {
      ...
      description: 'Real-time analytics for YouTube/TikTok creators. Need backend developer for data pipelines.',
  ...
  if (projectIds.length >= 2) {
    const applications = [
      { profile_id: testUsers.carol, project_id: projectIds[0], status: 'accepted', message: 'I would love to work on the frontend for this project!' },
      { profile_id: testUsers.david, project_id: projectIds[1], status: 'rejected', message: 'Interested in backend work. Let me know if I can help.' },
      { profile_id: testUsers.emma, project_id: projectIds[0], status: 'pending', message: 'This sounds exciting! I have Vue experience but can work with React.' },
      { profile_id: testUsers.emma, project_id: projectIds[1], status: 'pending', message: 'I have Python/Django backend experience.' }
    ];
  ...
  const messages = [
    { sender_id: testUsers.alice, recipient_id: testUsers.carol, content: 'Hi Carol! Saw your application. Your portfolio looks great! When can you start?', read: true },
    { sender_id: testUsers.carol, recipient_id: testUsers.alice, content: 'Hi Alice! Thanks! I can start next week. Excited to work on this!', read: true },
    { sender_id: testUsers.bob, recipient_id: testUsers.david, content: 'Hi David, thanks for applying. Unfortunately we need someone with more Redis experience.', read: true },
    { sender_id: testUsers.david, recipient_id: testUsers.bob, content: 'No problem! I understand. Good luck with the project!', read: false },
    { sender_id: testUsers.emma, recipient_id: testUsers.alice, content: 'Hi! I applied to your task manager project. Happy to discuss my React experience.', read: false },
    { sender_id: testUsers.carol, recipient_id: testUsers.david, content: 'Hey David! Saw your profile. Want to collaborate on a side project?', read: false }
  ];
