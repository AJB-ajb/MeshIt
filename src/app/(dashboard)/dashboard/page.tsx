...
async function fetchOwnerStats(supabase: Awaited<ReturnType<typeof createClient>>, userId: string): Promise<StatItem[]> {
...
async function fetchDeveloperStats(supabase: Awaited<ReturnType<typeof createClient>>, userId: string): Promise<StatItem[]> {
