    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-background p-4">
      <div className="mx-auto max-w-md text-center">
        <div className="mb-8">
          ...
          <h1 className="mb-2 text-3xl font-bold tracking-tight">You&apos;re Offline</h1>
          <p className="text-muted-foreground">
            It looks like you&apos;ve lost your internet connection. Don&apos;t worry, some
            features may still work with cached content.
          </p>
        </div>
        ...
        <div className="space-y-4">
          <div className="rounded-lg border bg-card p-4 text-left">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li className="flex items-start gap-2">
                <span className="mt-0.5">✗</span>
                <span>New matches and messages require connection</span>
              </li>
            </ul>
          </div>
