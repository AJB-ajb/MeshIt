...
5. **Given** the matching API endpoint (NFR)
   **When** called with valid profile
   **Then** response time is under 30 seconds for full generation
   **And** system supports 100+ concurrent users
